...
const CWGameState = (() => {
  ...
  /** Aperçu public : à quoi ressemblerait une personnage EN RUN (Niveau 1, forme de base), sans démarrer de run */
  function previewFashionWeekRunChar(instanceId) {
    return _fwMakeRunChar(instanceId);
  }
